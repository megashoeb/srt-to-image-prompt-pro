...
export const HISTORY_STYLES: Record<string, HistoryStyleConfig> = {
  "History 1 — 2D Animated": { id: "history_1", label: "History 1 — 2D Animated (Fire Accents)", description: "Hand-drawn 2D animation style. Cool slate blue + warm fire accents. Character Cards + Sacred Protocol. Best for: Animated history explainers.", chunkSize: 8, targetWords: 220, temperature: 0.7, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 2 — Sepia Story": { id: "history_2", label: "History 2 — Sepia Story-Illustration", description: "Sepia-toned 2D story-illustration with bold ink outlines. Character Cards + Sacred Protocol. Best for: Universal historical storytelling.", chunkSize: 8, targetWords: 220, temperature: 0.7, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 3 — Epic Cinematic": { id: "history_3", label: "History 3 — Epic Cinematic Matte", description: "Painterly cinematic concept art. Character Cards + Sacred Protocol. Best for: Historical epics, battle documentaries.", chunkSize: 7, targetWords: 250, temperature: 0.7, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 4 — Celestial Fantasy": { id: "history_4", label: "History 4 — Celestial Fantasy Panoramic", description: "Epic celestial fantasy matte painting. Character Cards + Sacred Protocol. Best for: Ancient empires, prophecy, sacred history.", chunkSize: 7, targetWords: 260, temperature: 0.75, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 5 — Romantic Oil": { id: "history_5", label: "History 5 — Romantic Oil-Painting", description: "Old-master inspired romantic oil-painting. Character Cards + Sacred Protocol. Best for: Royal history, devotional, maritime, Renaissance.", chunkSize: 7, targetWords: 250, temperature: 0.7, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 6 — Museum Parchment": { id: "history_6", label: "History 6 — Museum Artifact Parchment", description: "Oil on aged parchment with craquelure. Character Cards + Sacred Protocol. Best for: Ancient civilizations (Mongol, Roman, Persian).", chunkSize: 8, targetWords: 200, temperature: 0.7, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 7 — Documentary Auto": { id: "history_7", label: "History 7 — Documentary Auto Color/B&W", description: "Auto-decides Color or B&W per scene. Character Cards + Sacred Protocol. Best for: Biography, modern history documentaries.", chunkSize: 8, targetWords: 200, temperature: 0.7, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: true, wordCountByDuration: false },
  "History 8 — Impasto Oil": { id: "history_8", label: "History 8 — Impasto Oil Magical Realism", description: "Thick impasto oil painting with swirling brushstrokes. Character Cards + Sacred Protocol (Noor). Best for: Islamic/Egyptian history.", chunkSize: 7, targetWords: 240, temperature: 0.75, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: false },
  "History 9 — Ancient Fresco": { id: "history_9", label: "History 9 — Ancient Fresco Relief", description: "Ancient fresco / carved relief. Character Cards + Sacred Protocol. Word count varies by duration. Best for: Sleep/calm mythology.", chunkSize: 10, targetWords: 36, temperature: 0.65, needsCharacterCards: true, needsSacredProtocol: true, autoColorBW: false, wordCountByDuration: true },
};
